...
public interface IInventoryService
{
    ...
    Task<Result<InventoryItemDto>>
        CreateInventoryItem(CreateInventoryItemDto data, CancellationToken cancellationToken);

    Task<Result<InventoryItemDto>> UpdateInventoryItem(Guid id, UpdateInventoryItemDto data,
